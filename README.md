...
The following keys of 'both' are treated specially:

### tags

Added to the provided tags; however, both.tags does not affect filtering due to performance considerations
message: Converted to a string and moved to meta
